...
"""
Team: Adaptive_Truthfulness
Members: Ohad Daniel, Noam Nachum, Ori Hazan.
Strategy: Truthful bidding with time-varying random shading (pacing via increasing aggressiveness).
"""
class BiddingAgent:
    ...
    def bidding_function(self, item_id: str) -> float:
        ...
        # floor to 2 decimals (never goes above intended bid)
        bid = math.floor(bid * 100.0 + 1e-9) / 100.0
